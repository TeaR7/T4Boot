...
import static com.t4cloud.boot.core.base.constant.LogConstant.LOG_TYPE_USER;
import static com.t4cloud.boot.core.base.constant.LogConstant.OP_TYPE_EDIT;
...
@RequestMapping("/T4Cloud-User/SysUser")
public class SysUserController extends T4Controller<SysUser, ISysUserService> {
    ...
    public R<SysUser> detail(SysUser sysUser, HttpServletRequest req) {
        ...
        //查询用户角色
        List<SysRole> userRoleList = sysUserRoleService.getUserRoleList(detail.getId());
    ...
    public R save(@Valid @RequestBody SysUser sysUser, BindingResult bindingResult) {
        ...
        if (save) {
            ...
            sysUserRoleService.saveByUser(sysUserRole);
        }
    ...
    public R delete(@ApiParam(value = "主键集合", required = true) @RequestParam(name = "ids") String ids) {
        ...
        //删除用户角色
        sysUserRoleService.deleteByUser(ids);
