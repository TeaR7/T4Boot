...
import com.t4cloud.boot.core.base.annotation.cache.RoleCacheEvict;
import com.t4cloud.boot.core.base.controller.T4Controller;
import com.t4cloud.boot.core.base.entity.dto.R;
import com.t4cloud.boot.core.service.entity.SysUser;
...
@RequestMapping("/T4Cloud-System/SysUserRole")
public class SysUserRoleController extends T4Controller<SysUserRole, ISysUserRoleService> {
    ...
    public R<List<SysUser>> getUserList(@ApiParam("角色ID") @PathVariable String roleId,
