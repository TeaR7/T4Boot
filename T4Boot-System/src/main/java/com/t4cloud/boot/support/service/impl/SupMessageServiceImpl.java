        ...
        for (SupMessage record : supMessageList) {
            ...
            try {
                ...
                if (areaCode.equalsIgnoreCase("086") || areaCode.equalsIgnoreCase("86")) {
                    ...
                    //填充短信参数
                    boolean sendSms = SmsUtil.sendSms(phone, JSONUtil.parseObj(record.getParam()), template);
                    if (!sendSms) {
