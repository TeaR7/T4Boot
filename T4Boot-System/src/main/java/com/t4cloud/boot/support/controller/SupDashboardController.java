...
import com.t4cloud.boot.support.entity.SysLog;
import com.t4cloud.boot.support.service.ISysLogService;
...
@RestController
@AllArgsConstructor
@RequestMapping("/T4Cloud-Support/dashboard")
@Api(value = "访问统计等数据接口", tags = "数据统计", position = 0)
public class SupDashboardController extends T4Controller<SysLog, ISysLogService> {
